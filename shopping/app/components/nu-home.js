...
function NuHome(props) {
  let product
  if(props.product.products){
   product = props.product.products.filter((item) => item.categoryId.name == "nữ");
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.title}>
        <TouchableOpacity>
          <Text style={styles.titleLeft}>Nữ</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
export default connect(mapStateToProps, null)(NuHome);
