...
function NamHome(props) {
  let product
  if(props.product.products){
   product = props.product.products.filter((item) => item.categoryId.name == "nam");
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.title}>
        <TouchableOpacity>
          <Text style={styles.titleLeft}>Nam</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
export default connect(mapStateToProps, null)(NamHome);
