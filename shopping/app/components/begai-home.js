...
function BeGaiHome(props) {
  let product
  if(props.product.products){
   product = props.product.products.filter((item) => item.categoryId.name == "bé gái");
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.title}>
        <TouchableOpacity>
          <Text style={styles.titleLeft}>Bé Gái</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
export default connect(mapStateToProps, null)(BeGaiHome);
